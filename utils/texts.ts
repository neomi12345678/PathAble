...
export const PROFILE = {
  ...
  premiumTitle: "שדרג לפרמיום",
  premiumDesc: "קבל/י גישה למשרות בלעדיות וניתוח קורות חיים מבוסס AI",
  premiumCta: "למד/י עוד",
  ...
  profileVisible: "פרופיל גלוי למעסיקים",
  profileVisibleDesc: "אפשר לחברות למצוא אותך בחיפוש",
  darkMode: "מצב כהה (Dark Mode)",
  darkModeDesc: "שנה/י את ממשק המערכת לצבעים כהים",
